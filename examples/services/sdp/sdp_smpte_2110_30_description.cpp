...
#include "rdk/examples/services/sdp/sdp_smpte_2110_30_description.h"
...
constexpr const char* EXAMPLE_DESCRIPTION = "NVIDIA Rivermax Dev Kit SMPTE 2110-30 SDP String Generation Example";
constexpr const char* EXAMPLE_USAGE = "Examples:\n"
                                      "  1. generate_smpte_2110_30_sdp";

SMPTE_2110_30_SDPGenerationExample::SMPTE_2110_30_SDPGenerationExample() :
    BaseExample(EXAMPLE_DESCRIPTION, EXAMPLE_USAGE)
{
}

ReturnStatus SMPTE_2110_30_SDPGenerationExample::operator()()
{
    ...
    auto media_description = SMPTE2110_30_MediaDescription::Builder(
        destination_port, TransportProtocol::RTP_AVP, "97", destination_ip)
...
{
    return rivermax::dev_kit::examples::common_example_main<SMPTE_2110_30_SDPGenerationExample>(argc, argv);
}
